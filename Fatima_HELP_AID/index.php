...
<body class="body">
    ...
    <div class="hero-text container-fluid p-3 mt-3">
        <h1 class="h1 p-2 text-center">Welcome to HELP-Aid,</h1>
        <p class="p ms-3 mb-2 text-center">where need meets compassion</p>
        <div class="hero-row row justify-content-center text-center m-4 mb-5">
            <div class="hero-col col-12 col-lg-3 p-2 me-1"><a class="a" href="#"><img class="img" src="KJK_Logo.png" alt="#kitajagakita">#kitajagakita</a></div>
            <div class="hero-col col-12 col-lg-3 p-2 me-1"><a class="a" href="#"><i class="fa-solid fa-hand-holding-heart"></i>#HelpingHand</a></div>
            <div class="hero-col col-12 col-lg-3 p-2 me-1"><a class="a" href="#"><i class="fa-solid fa-flag"></i>#WhiteFlag</a></div>
        </div>
        <div class="verification row justify-content-center align-items-center p-3 mt-5 mb-4">
            <div class="col-12 header mt-3 mb-2"><h2 class="h2 text-center mx-auto p-1">
                Are you an admin or organization-representative?
            </h2></div>
            <div class="ver-col col-lg-3 col-sm text-center p-1 m-1"><a class="a p-2" href="adminMenu.html">I'm an Admin</a></div>
            <div class="ver-col col-lg-3 col-sm text-center p-1 m-1"><a class="a p-2" href="representativeMenu.html">I'm a Representative</a></div>
        </div>
    </div>
